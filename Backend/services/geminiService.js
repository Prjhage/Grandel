...
module.exports.getTravelSuggestions = async (city, days) => {
    try {
        ...
        const prompt = `
Generate a travel plan for ${city} for ${days} days. Focus on the top 5 best tourist attractions and famous landmarks.

Return ONLY valid JSON. No markdown. No extra text and simple words.

FORMAT:
{
  "places": ["Famous Tourist Attraction 1", "Famous Tourist Attraction 2", "Famous Tourist Attraction 3", "Famous Tourist Attraction 4", "Famous Tourist Attraction 5"],
